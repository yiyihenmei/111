"use strict";
let dlbtn = document.getElementsByTagName('button')[0];
...
let ul2 = document.getElementsByTagName('ul')[2];
let ul3 = document.getElementsByTagName('ul')[3];
let tjcg = document.getElementsByTagName('h4')[0];
let tscz = document.getElementsByTagName('h4')[1];
...
let arrays = [];
let arrayss = [];
let zhengze = /^(13[0-9]|14[01456879]|15[0-35-9]|16[2567]|17[0-8]|18[0-9]|19[0-35-9])\d{8}$/;
array = [
    {
        img: "1.jpg",
        name: "红楼梦",
...
let suiji1 = Math.floor(Math.random() * (255 - 0 + 1)) + 0;
let suiji2 = Math.floor(Math.random() * (255 - 0 + 1)) + 0;
let suiji3 = Math.floor(Math.random() * (255 - 0 + 1)) + 0;
// 渲染
function xr(arr) {
...
function bwykw(ele) {
    var _a;
    let name = (_a = ele.parentNode) === null || _a === void 0 ? void 0 : _a.children[0].innerHTML;
